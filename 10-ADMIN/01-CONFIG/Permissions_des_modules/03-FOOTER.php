	...
	<!--this page plugins-->
	  ...
	  <script src="01-TEMPLATE/FLAT-ADMIN/js/bootstrap-switch.js"></script>
  ...
  <script type="text/javascript" src="01-TEMPLATE/FLAT-ADMIN/assets/jquery-multi-select/js/jquery.quicksearch.js"></script>
	...
	<script type="text/javascript" src="01-TEMPLATE/FLAT-ADMIN/js/jquery.validate.min.js"></script>
